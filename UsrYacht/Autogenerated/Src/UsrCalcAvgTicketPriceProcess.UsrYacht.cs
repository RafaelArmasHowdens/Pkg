namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAvgTicketPriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalcAvgTicketPriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalcAvgTicketPriceProcessMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var passengersCountColumn = esq.AddColumn("UsrPassengerNumber");  // SELECT UsrPassengersCount as UsrPassengersCount, UsrPrice as UsrPrice FROM UsrYacht WHERE ...
